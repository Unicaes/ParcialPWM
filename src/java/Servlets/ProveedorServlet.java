...
public class ProveedorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        item.contacto=request.getParameter("txtContact");
        item.nombre_proveedor=request.getParameter("txtNombreProv");
        item.telefono=request.getParameter("txtMobile");
        Proveedores.Agregar(item);
